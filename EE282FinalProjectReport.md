...
In summary, based on the analysis done in this report, though it looks like the more synchronized expression of core clock genes at a higher level is the cause behind the difference in amplitude of clock gene expressions in ependymal cells and neurons, more analyses need to be done to achieve a tenable conclusion. 
